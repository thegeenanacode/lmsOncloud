...
public class Course implements Serializable {
    ...
    public void setDiscussions(Set<Discussion> discussions) {
        if (this.discussions != null) {
            this.discussions.forEach(i -> i.setCourse(null));
        }
        if (discussions != null) {
            discussions.forEach(i -> i.setCourse(this));
        }
        this.discussions = discussions;
    }

    public Course discussions(Set<Discussion> discussions) {
        this.setDiscussions(discussions);
        return this;
    }

    public Course addDiscussion(Discussion discussion) {
        this.discussions.add(discussion);
        discussion.setCourse(this);
        return this;
    }

    public Course removeDiscussion(Discussion discussion) {
