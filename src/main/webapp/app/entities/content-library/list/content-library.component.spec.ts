...
import { sampleWithRequiredData } from '../content-library.test-samples';
...
describe('ContentLibrary Management Component', () => {
  let comp: ContentLibraryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ContentLibraryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contentLibraries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to contentLibraryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContentLibraryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContentLibraryIdentifier).toHaveBeenCalledWith(entity);
