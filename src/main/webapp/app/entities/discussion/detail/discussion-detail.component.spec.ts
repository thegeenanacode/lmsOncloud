...
describe('Discussion Management Detail Component', () => {
  ...
  describe('OnInit', () => {
    it('Should load discussion on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', DiscussionDetailComponent);

      // THEN
      expect(instance.discussion()).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
