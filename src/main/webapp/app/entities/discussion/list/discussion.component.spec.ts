...
import { sampleWithRequiredData } from '../discussion.test-samples';
...
describe('Discussion Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.discussions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to discussionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDiscussionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDiscussionIdentifier).toHaveBeenCalledWith(entity);
