...
public class MessageTestSamples {
    ...
    public static Message getMessageSample1() {
        return new Message().id(1L).sender("sender1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static Message getMessageSample2() {
        return new Message().id(2L).sender("sender2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
